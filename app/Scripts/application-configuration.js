...
define(['angularAMD', 'angular-route', 'angular-sanitize', 'blockUI', 'angular-css', 'ng-table', 'bt-ng-slider', 'ui-grid-unstable', 'rzSlider', 'ui-bootstrap-tpls', 'smart-table'], function (angularAMD) {
    ...
    app.constant("appSettings", {
        ...
        APPLICATION_VERSION: 'A3.5 (r1447)',
    ...
    app.constant("Notify", {
        ...
        CUSTOMER_SETTINGS_DISTINCT_REGION_DATA_READY:'customerSettingsFactory::customerSettingsDistinctRegionDataReady',
        CUSTOMER_SETTINGS_DISTINCT_SITE_DATA_READY:'customerSettingsFactory::customerSettingsDistinctSiteDataReady',
        RELOAD_DATASET_FOR_CUSTOMER_SETTINGS_CHANGED:'customerSettingsCtlr::reloadDatasetForCustomerSettingsChanged',
        LEFT_MENU_FOLD_BUTTON_CLICK:'actionRootCtlr::leftMenuHide',
        TOP_LEVEL_FILTER_DATA_READY:'dataFilterController::topLevelFilterDataReady',
        CLOSE_SETTINGS_WINDOW:'cutomerSettingsController::closeSettingsWindow'
    });
    ...
    var indexController = function ($scope, $rootScope, $http, $location, blockUI) {
        ...
        var validateSession = function(){
            ...
            var user = {
                ...
                email: tokenList[0][1].innerHTML,
                sessionId: tokenList[0][2].innerHTML,
                selectedCustomer: tokenList[0][3].innerHTML
            };
