...
angular.module("angular-block-ui/angular-block-ui.tmpl.html", []).run(["$templateCache", function($templateCache) {
  ...
  "<div ng-show=\"state.blocking\" class=\"block-ui-message-container float-down\">\n" +
  "<div class=\"block-ui-message \">{{ state.message }} <i class='show-loading-image-animation'><img src='Content/images/itsat-loading.png' width='28px' height='28px'  class='make-loading-rotation'/> </i> </div>  \n" +
  "</div>\n" +
  ""
//     "<div ng-show=\"state.blockCount > 0\" ng-class=\"{ 'block-ui-visible': state.blocking}\" ng-include=\"'Views/Shared/Template/MinLoadingOverlayTemplate.html'\"></div>"
  );
}]);
