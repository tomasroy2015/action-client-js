...
require.config({
    ...
    paths: {
       ...
       // 'EvaluationData': 'Factories/EvaluationData',
        ...
        'customerSettingsFactory':'Factories/CustomerSettingsFactory',
        ...
        'addToGroupController':'Views/DataFilter/AddToGroupWindowController',
        'userAccountSettingsController':'Views/CustomerSettings/UserAccountSettings/UserAccountSettingsController',
        'generalSettingsController':'Views/CustomerSettings/GeneralSettings/GeneralSettingsController',
        'confirmationAlertDialogDirective':'Views/Shared/Directive/ConfirmationAlertDialogDirective',
        'actionAddOrEditUserDirective':'Views/CustomerSettings/UserAccountSettings/AddOrEditUserDirective',
        'countryMappingController':'Views/CustomerSettings/CountryMapping/CountryMappingController',
        'datasetController':'Views/Dataset/DatasetSelectionController',
        'regionMappingController':'Views/CustomerSettings/RegionMapping/RegionMappingController',
        'siteClusteringController':'Views/CustomerSettings/SiteClustering/SiteClusteringController',
        'comparatorMappingController':'Views/CustomerSettings/ComparatorMapping/ComparatorMappingController',
        'dataFilterSettingsController':'Views/CustomerSettings/DataFilterSettings/DataFilterSettingsController',
        'addOrEditDataFilterDirective':'Views/CustomerSettings/DataFilterSettings/AddOrEditDataFilterDirective',
        'ipMappingController':'Views/CustomerSettings/IPMapping/IPMappingController',
        'shortCodeMappingController':'Views/CustomerSettings/ShortCodeMapping/ShortCodeMappingController',
        'actionEditShortCodeMappingDirective':'Views/CustomerSettings/ShortCodeMapping/EditShortCodeMappingDirective',
        'addOrEditIpMappingDirective':'Views/CustomerSettings/IPMapping/AddOrEditIpMappingDirective',
        'DivDisableDirective':'Views/Shared/Directive/DivDisableDirective',
        'EvaluationBtnDisableDirective':'Views/LeftMenu/EvaluationBtnDisableDirective',
        'addEditCountryMappingDirective':'Views/CustomerSettings/CountryMapping/AddEditCountryMappingDirective',
        'individualEvaluationSummaryBar':'Views/LeftMenu/Evaluation/IndividualEvaluationSummaryBarDirective',
        'CustomTruncatedToolTip':'Views/Shared/Directive/CustomTruncatedToolTip',
        'addEditRegionMappingDirective':'Views/CustomerSettings/RegionMapping/AddEditRegionMappingDirective',
        'addEditSiteMappingDirective':'Views/CustomerSettings/SiteClustering/AddEditSiteMappingDirective',
        'popoverDirective':'Views/Shared/Directive/CustomPopOver',
        'addPredefinedCountryValueDirective':'Views/CustomerSettings/CountryMapping/AddPredefinedCountryValueDirective',
        'evaluationTruncatedToolTip':'Views/Shared/Directive/EvaluationTruncatedToolTip',
        'dateRangeSelectionDirective':'Views/Shared/Directive/DateRangeSelectionDirective',
        'confirmationWindowController':'Views/DataFilter/ConfirmationWindowController',
        'groupDeleteConfirmationWindowController':'Views/DataFilter/GroupDeleteConfirmationWindowController'
    },
    ...
    shim: {
        ...
        'leftMenuController': ['dataFilterDirective','DivDisableDirective','EvaluationBtnDisableDirective', 'serviceAreaDirective', 'serviceAreaQuestionsDirective', 'lodash', 'datasetDirective', 'serviceAreaScoreData', 'fullScorecardController', 'dataFilterViewDirective', 'colorSetDirective', 'dataFilterController', 'serviceAreaScoreBoxController', 'compareWithSettingsController', 'moreSettingsController', 'serviceAreaEvaluationsDirective', 'evaluationController', 'columnHeaderGrpDirectives', 'evaluationAnswerScoresDirective', 'customizableScoreBarDirective', 'OSRatio', 'VerticalScrollbarCheckingDirective', 'EvaluationSummaryDirective','CustomTruncatedToolTip','popoverDirective'],
        ...
        'dataFilterSettingsController':['confirmationAlertDialogDirective','addOrEditDataFilterDirective'],
        'customerSettingsController':['lodash','userAccountSettingsController','generalSettingsController','countryMappingController','regionMappingController','siteClusteringController','comparatorMappingController','ipMappingController','shortCodeMappingController','dataFilterSettingsController'],
        'userAccountSettingsController':['confirmationAlertDialogDirective','actionAddOrEditUserDirective'],
        'shortCodeMappingController':['actionEditShortCodeMappingDirective'],
        'ipMappingController':['addOrEditIpMappingDirective','confirmationAlertDialogDirective'],
        'countryMappingController':['addEditCountryMappingDirective','addPredefinedCountryValueDirective','dateRangeSelectionDirective'],
        'evaluationController':['individualEvaluationSummaryBar'],
        'regionMappingController':['addEditRegionMappingDirective'],
        'siteClusteringController':['addEditSiteMappingDirective']
    },
